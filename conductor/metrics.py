...
def init_conductor_metrics() -> None:
    ...
    # ── Composer ──────────────────────────────────────────────────────────
    reg.register("conductor_composer_objectives_total", "counter", "Total Composer objectives submitted")
    reg.register("conductor_composer_objectives_active", "gauge", "Active Composer objectives")
    reg.register("conductor_composer_objectives_completed_total", "counter", "Composer objectives completed")
    reg.register("conductor_composer_objectives_blocked_external_total", "counter", "Composer objectives blocked externally")
    reg.register("conductor_composer_plans_total", "counter", "Composer plans generated")
    reg.register("conductor_composer_tasks_dispatched_total", "counter", "Composer tasks dispatched")
    reg.register("conductor_composer_tasks_completed_total", "counter", "Composer tasks completed")
    reg.register("conductor_composer_interactions_answered_total", "counter", "Composer interactions answered")
    reg.register("conductor_composer_task_restarts_total", "counter", "Composer task restarts")
    reg.register("conductor_composer_reports_generated_total", "counter", "Composer reports generated")
    reg.register("conductor_composer_llm_errors_total", "counter", "Composer LLM errors")